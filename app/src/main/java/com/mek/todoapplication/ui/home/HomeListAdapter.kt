...
import com.mek.todoapplication.databinding.ItemHomeFragmentTodoBinding
...
class HomeListAdapter(private val toDoClickListener: ToDoClickListener) : ListAdapter<ToDoModel,HomeListAdapter.ViewHolder>(ToDoDiffCallBack()) {
    class ViewHolder(private val binding : ItemHomeFragmentTodoBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        companion object{
            fun from(parent: ViewGroup) : ViewHolder{
                val binding = ItemHomeFragmentTodoBinding.inflate(LayoutInflater.from(parent.context),parent,false)
